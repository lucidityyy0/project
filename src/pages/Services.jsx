...
const Services = () => {
  ...
  return (
    <div className="font-sans text-gray-800">
      {/* Hero Section */}
      <section className="relative h-[68vh] min-h-[420px] sm:min-h-[480px] lg:min-h-[620px] lg:h-[72vh] overflow-hidden">
        ...
        {/* White Overlay Shape */}
        <div className="absolute bottom-0 left-0 w-full lg:w-[45%] bg-white rounded-tr-[2.5rem] sm:rounded-tr-[5rem] p-5 sm:p-8 lg:p-16 xl:p-20 pt-14 sm:pt-20 lg:pt-28">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-light text-gray-900 mb-4 sm:mb-6">{t('servicesPage.hero.title')}</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <div key={index} className="group relative min-h-[460px] sm:min-h-[520px] lg:min-h-[560px] rounded-[2rem] overflow-hidden cursor-pointer">
                {/* Background Image */}
                <img
                ...
                <div className="absolute inset-0 p-4 sm:p-6 lg:p-8">
                  <div className="frosted-glass-dark h-full rounded-[1.6rem] p-4 sm:p-6 lg:p-8 flex flex-col justify-between">
                    <div>
      ...
      {/* Bottom CTA */}
      <section className="pb-14 sm:pb-20 lg:pb-32 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-8 h-auto lg:h-[600px]">
            {/* Left Image */}
            <div className="lg:w-1/2 rounded-[3rem] overflow-hidden relative h-[320px] sm:h-[400px] lg:h-auto">
              <img
            ...
            {/* Right Content */}
            <div className="lg:w-1/2 bg-accent-50 rounded-[3rem] p-8 sm:p-12 lg:p-20 flex flex-col justify-center">
              <span className="text-xs font-bold uppercase tracking-widest text-gray-500 mb-4">
                {t('servicesPage.cta.subtitle')}
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-5xl font-light text-gray-900 mb-6 sm:mb-8 leading-tight" dangerouslySetInnerHTML={{ __html: t('servicesPage.cta.title') }} />
              <p className="text-gray-600 text-sm sm:text-base lg:text-lg leading-relaxed mb-8 sm:mb-12 max-w-xl">
                {t('servicesPage.cta.description')}
              </p>
              <div>
                <Link to="/contact" className="bg-primary-600 text-white px-7 py-3.5 rounded-lg font-medium hover:bg-primary-700 transition-colors inline-block">
